      ...
      <div className="w-full xl:h-screen h-[80vh] flex px-[5%] items-center">
        <div className="md:w-[50%]">
          <div className="pb-5">
            <div class="flex items-center gap-4">
              <div class="social-button">
                <button class="relative w-10 h-10 rounded-full group">
              ...
              <div class="social-button">
                <button class="relative w-10 h-10 rounded-full group">
                  <div class="floater w-full h-full absolute top-0 left-0 bg-[#0288D1] rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl"></div>
                  <div class="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-[#0288D1] rounded-full">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      x="0px"
                      y="0px"
              ...
              <div class="social-button">
                <button class="relative w-10 h-10 rounded-full group">
                  <div class="floater w-full h-full absolute top-0 left-0 bg-red-500 rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl"></div>
                  <div class="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-red-500  rounded-full">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      x="0px"
                      y="0px"
              ...
              <div class="social-button">
                <button class="relative w-10 h-10 rounded-full group">
                  <div class="floater w-full h-full absolute top-0 left-0 bg-[#098FE6] rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl"></div>
                  <div class="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-[#2AA4F4] rounded-full">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      x="0px"
                      y="0px"
          ...
          <div className="flex gap-5">
            <button class="hover:brightness-110 hover:animate-pulse font-bold py-3 px-6 rounded-full bg-[#5924a8] shadow-md hover:shadow-[#8f68c9] text-white">
              Contact Me
            </button>
            <button class="hover:brightness-110 hover:animate-pulse font-bold py-3 px-6 rounded-full border border-[#5924a8] shadow-md hover:shadow-[#8f68c9] text-white">
              Download CV
            </button>
          </div>
        </div>
        <div className="md:w-[45%]">dwddqwd</div>
      </div>
    </section>
  );
};
